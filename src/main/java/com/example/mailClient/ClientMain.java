...
public class ClientMain extends Application {
   ...
   * FXMLLoader(ClientMain.class.getResource("RootLayout.fxml"));
   ...
   * try {
   * FXMLLoader loader = new
   * FXMLLoader(ClientMain.class.getResource("MailContainer.fxml"));
   ...
   * try {
   * FXMLLoader loader = new
   * FXMLLoader(ClientMain.class.getResource("NewMessage.fxml"));
   ...
   * popup.
   * setContentText("Server propably is offline or check your internet connection"
   * );
   * popup.show();
   * }
   * 
   ...
   * try {
   * FXMLLoader loader = new
   * FXMLLoader(ClientMain.class.getResource("Login.fxml"));
